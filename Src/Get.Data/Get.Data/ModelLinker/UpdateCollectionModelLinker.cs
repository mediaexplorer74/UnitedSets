...
public class UpdateCollectionModelLinkerDelegate<TSource, TDest>(IUpdateReadOnlyCollection<TSource> source, IGDCollection<TDest> dest, Func<TSource, TDest> createFrom) : UpdateCollectionModelLinker<TSource, TDest>(source, dest)
{
...
public abstract class UpdateCollectionModelLinker<TSource, TDest> : IDisposable
{
    ...
    public void DisposeAndRemoveAll()
    {
        Dispose();
        DestinationList.Clear();
    }
